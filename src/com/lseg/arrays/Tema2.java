...
public class Tema2 {
    ...
    static void bancomat()
    {
        ...
        do {
            ...
            if(pinIntrodus==pinCorect){System.out.println("PIN-ul este corect!");pinValid=true;}
            else{System.out.println("PIN-ul este incorect!");count++;}
        }
        while(!pinValid && count<3);
        if(count==3){System.out.println("Card blocat! Numar maxim de incercari atins!");}
        }
